...
Pertussis (a.k.a whopping cough) is a common lung infection caused by
the bacteria B. Pertussis

This can infect all ages but is most server for those under 1 year of
age.
...
> (1946), the switch to the newer aP vaccine (2020).
...
After the introduction of aP vaccine in the 1990s, these cases remained
low, and later on began to increase in the late 1990s. A possible
explanation for the observed trend may be that vaccines resulted into a
weaker immunity. The increase in cases could have been a result of
people rejecting vaccination, which allowed diseases to spread more
easily. Moreover, you can see that in 2020 in began to increase again,
which is when covid made an appearance.
...
They make there data availavle via JSON format returinign API. We can
...
> Q4. How many wP ans aP individuals are in this `subject` table?
...
> Q5. What is the biological sex breakdown?
...
> Q6. In terms of race and gender is this dataset representative of US
> population?
...
We can use `*_join()` family of functions from **dplyr** to do this
...
> Q. Is there a difference for aP vs wP indivuduals with these values?
...
Yes it does show temporal response, it increases over time.
...
IgG antibody levels against pertussis toxin increase rapidly,
specifically around 14 days and then begin to decline.
